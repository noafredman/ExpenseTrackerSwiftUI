...
final class HomeViewModelTests: XCTestCase {
    ...
    func testUpdateData_succeed() {
        ...
        runPerParameter(HomeViewModel.UpdateDataType.filter(date: expenseCluster.date, expense: expense), HomeViewModel.UpdateDataType.removedInfo, HomeViewModel.UpdateDataType.none) { [self] updateDataType in
            ...
            case .removedInfo:
                ...
                XCTAssertEqual(homeViewModel.expenseClusterList, [expenseCluster])
            case .none:
                XCTAssertEqual(homeViewModel.didDeleteInfo, false)
                XCTAssertEqual(homeViewModel.expenseClusterList, [expenseCluster])
            }
    ...
    func testRemovedExpense_expectError() {
        ...
        runPerParameter((expenseClusterToRemove.id, expense.id, HomeViewModel.HomeViewModelError.expenseClusterNotFoundError), (expenseCluster.id, expenseToRemove.id, HomeViewModel.HomeViewModelError.expenseNotFoundError)) { [self] paramTuple in
